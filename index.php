...
<html lang="en">
  ...
  <body>
          ...
          <div class="hero-overlay">
            ...
            >
              ...
              >
                <span
                  id="days"
                  class="block text-4xl sm:text-5xl lg:text-7xl font-mono font-bold text-red-500 drop-shadow-[0_0_15px_#ef4444]"
                  >00</span
                >
                <span
                  class="block mt-2 text-sm sm:text-lg uppercase tracking-wider text-red-400 drop-shadow-[0_0_8px_#ef4444]"
                  >Days</span
                >
              </div>
    ...
    <script>
      ...
      const EVENT_DATE = "2025-10-10T10:00:00"; // Setting to 10:00 AM start time
